...
def jsontocsvfile(data, outfileflag=True, outputfile=None):
    def js_r(data):
...
def removewordsfile(outfile):
    ...
    text = ''.join([i for i in text]) \
        ...
        .replace(", 'label': ", " ") \
        .replace("}", "") \
        .replace(",entity 1", "Sentences,entity 1")
...
if fileoption.lower() == 'file' or 'f':
    ...
    removewordsfile(outfile)


# JsontoCSV for a single file ends here


elif fileoption.lower() == 'dir' or fileoption.lower() == 'folder':
